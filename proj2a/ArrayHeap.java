...
public class ArrayHeap<T> implements ExtrinsicPQ<T> {
    ...
    /**
     * Returns the item of the Node with the smallest priority value, but does not remove it
    ...
    /**
     * Returns the item of the Node with the smallest priority value, and removes it from
