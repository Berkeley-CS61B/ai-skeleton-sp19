...
import bearmaps.proj2c.GraphDB;
...
public class Constants {
     ...
     **/
    public static final String OSM_DB_PATH = "../library-sp18/data/berkeley-2018.osm.xml";

    /** The tile images are in the IMG_ROOT folder. */
    public static final String IMG_ROOT = "../library-sp18/data/proj3_imgs/";
    ...
    /**
     * This is used to maintain a single GRAPH DB instance(object) so that the same instance is accessed
     * from everywhere in the code. Enum is a cleaner way to achieve such a singleton pattern.
     */
    public static final GraphDB GRAPH_DB_INSTANCE = new GraphDB();
