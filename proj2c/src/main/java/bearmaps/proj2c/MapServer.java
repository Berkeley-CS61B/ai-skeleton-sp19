...
/**
 * This bearmaps.proj2c.MapServer class is the entry point for running the JavaSpark web bearmaps.proj2c.server for the BearMaps
...
public class MapServer {
    ...
    /**
     * This is where the bearmaps.proj2c.MapServer is started. All the API routes that need to be served are initialized here.
     * @param args
     */
