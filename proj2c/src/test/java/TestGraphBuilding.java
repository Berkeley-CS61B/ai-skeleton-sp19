...
/**
 * Basic sanity check for your bearmaps.proj2c.GraphDB construction. This test simply tests a small number of
 * hard coded queries, but if you get them right, your bearmaps.proj2c.GraphDB class is probably correct.
 */
public class TestGraphBuilding {
    ...
    public void setUp() throws Exception {
        ...
        graph = new GraphDB();
        graphSmall = new GraphDB();
        graph.initialize(OSM_DB_PATH);
        graphSmall.initialize(OSM_DB_PATH_SMALL);
        initialized = true;
    }
