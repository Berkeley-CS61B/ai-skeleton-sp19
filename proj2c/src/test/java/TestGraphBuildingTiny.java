 ...
 * Basic sanity check for your bearmaps.proj2c.GraphDB construction on a tiny clean input graph.
 */
public class TestGraphBuildingTiny {
    ...
    public void setUp() throws Exception {
        ...
        graphTiny = new GraphDB();
        graphTiny.initialize(OSM_DB_PATH_TINY);
        initialized = true;
    }
